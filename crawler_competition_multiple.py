...
from bs4 import BeautifulSoup #: 정적인 웹페이지 크롤링
from selenium import webdriver# : 동적인 웹페이지 크롤링

import time #시간 라이브러리
from tqdm import tqdm # 진행율을 표시하는 라이브러리 + for문과 같이 씀

import pandas as pd # 크롤링한 내용을 엑셀 파일로 저장하기 위해
#xlsx -> openpyx1(파이썬으로 엑셀컨트롤)
#csv -> pandas 사용
